 ...
 * Basic site info
 */
$site_title  = 'Project Lazarus AllaClone';
 ...
 * Options
 */
$use_pace_loader = false; /* shows a loader at the top of the page */
$hide_navbar     = false;

$site_logo = ""; /* Where you put your site logo */

$root_url     = 'https://localhost/Alla';
...
$allow_quests_npc                   = true; // quests for npcs are available from NPC's page
...
$max_npcs_returned                  = 250; // max number of npcs returned by search engines (0=all)
$max_tasks_returned					= 250;
$server_max_npc_level               = 85; // Max Level for any NPCs on the Server
$show_npc_drop_chances              = true; // if TRUE, chances of droping of each item will be shown when browsing npcs
$show_npc_number_in_zone_level_list = false; // choose between number and x for npcs in zone levels list
...
$trackable_npcs_only                = false; // If TRUE, will only display NPCs that are set to be trackable in search results
...
$max_items_returned          = 250; // max number of items returned by search engines (0=all)
...
$server_max_level              = 70; // Max Level for Characters on the Server
...
$ignore_zones = ["load", "loading", "load2", "nektropos", "arttest", "apprentice", "tutorial", "cshome"];
